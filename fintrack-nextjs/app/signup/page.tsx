        ...
        <AnimatePresence mode="wait">
            ...
            >
                ...
                <AnimatePresence>
                    {showSuccess && (
                        ...
                        >
                            ...
                            >
                                <motion.div
                                    className="w-24 h-24 mx-auto mb-6 rounded-full bg-[#2ECC71] flex items-center justify-center"
                                    initial={{ scale: 0 }}
                                    animate={{ scale: 1 }}
                ...
                >
                    ...
                    {/* Main Content - Calming Finance Illustration */}
                ...
                >
                    ...
                    <div className="w-full max-w-md relative z-10">
                        ...
                        >
                            ...
                            <motion.p
                                className="mb-5 mt-4 text-center text-lg font-semibold"
                                initial={{ y: 20, opacity: 0 }}
                                animate={{ y: 0, opacity: 1 }}
                                transition={{ delay: 0.5 }}
                            >
                                Join <span style={{ color: '#0A2A43' }}>Hisaab</span><span style={{ color: '#2ECC71' }}>X</span> today
                            </motion.p>

                            <form onSubmit={handleSubmit} className="space-y-3">
                                {[
                                    { label: 'Username', type: 'text', value: username, setValue: setUsername, placeholder: 'Choose username', delay: 0.5 },
                                    { label: 'Email Address', type: 'email', value: email, setValue: setEmail, placeholder: 'your.email@example.com', delay: 0.55 }
                                ].map((field, index) => (
                                    <motion.div
                                        key={index}
                                    ...
                                    >
                                        <label className="block text-xs font-medium mb-1" style={{ color: '#0A2A43' }}>
                                            {field.label}
                                        </label>
                                        <input
                                            type={field.type}
                                            ...
                                            className="w-full px-4 py-2 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all text-sm"
                                            style={{
                                                borderColor: '#E5E7EB',
                                ...
                                >
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full px-4 py-2 pr-12 border-2 rounded-xl focus:outline-none focus:ring-2 transition-all text-sm"
                                            style={{
                                                borderColor: '#E5E7EB',
                                                backgroundColor: '#F2F4F8'
                                            }}
                                ...
                                <motion.button
                                    type="submit"
                                    disabled={loading}
                                    className="w-full py-2.5 rounded-xl font-semibold text-white transition-all hover:opacity-90 disabled:opacity-50 text-sm"
                            ...
                            >
                                <motion.button
                                    ...
                                    className="w-full py-2.5 rounded-xl font-medium transition-all border-2 text-sm"
                                    style={{
                                        color: '#0A2A43',
                                        borderColor: '#0A2A43',
