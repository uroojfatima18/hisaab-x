...
export default function SignupPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Generate a random avatar seed for unique avatar
    ...
    return (
        <div className="min-h-screen flex items-center justify-center px-4 py-8" style={{ backgroundColor: '#F2F4F8' }}>
            <div className="w-full max-w-md">
                <div className="bg-white rounded-3xl shadow-hover p-10">
                    ...
                    <p className="mb-8 text-center" style={{ color: '#0A2A43' }}>
                        <span className="text-xl font-semibold">Join HissabX today</span>
                    </p>

                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div>
                            <label className="block text-sm font-medium mb-2" style={{ color: '#0A2A43' }}>
                                Username
                            </label>
                            <input
                                type="text"
